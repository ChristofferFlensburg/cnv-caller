...
metaDataFile = '~/testCNV/metaData.txt'
...
vcfFiles = list.files('~/testCNV/vcf', pattern='*.vcf$', full.names=T)
...
captureRegionsFile = '~/testCNV/captureRegions.gc.bed'
...
normalDirectory = '~/testCNV/normals'
